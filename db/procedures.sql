USE [abcdRent]
GO
/****** Object:  StoredProcedure [dbo].[spAddCar]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[spAddCar] 
...
END
GO
/****** Object:  StoredProcedure [dbo].[spAddInsurance]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
  ...
  END; 
GO
/****** Object:  StoredProcedure [dbo].[spAddVisa]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
  ...
  END; 
GO
/****** Object:  StoredProcedure [dbo].[spArrivedBetween]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
    ...
    SELECT *
    FROM vwRentsInfo
    WHERE RETURNEDDATE BETWEEN @date1 AND @date2;
END;
GO
/****** Object:  StoredProcedure [dbo].[spCarRevenue]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[spChangePassword]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[spCheckMyRent]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	...
	FROM CARRENTAL cr
	INNER JOIN vwCarInfoWithPrice vw ON cr.CARID = vw.[Car ID]
...
END
GO
/****** Object:  StoredProcedure [dbo].[spConfirmArrival]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [dbo].[spDeleteCar]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
  ...
  --discuss
GO
/****** Object:  StoredProcedure [dbo].[spInitRefundRequest]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[spLoadManufacturer]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[spLoadTypes]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[spRefund]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  StoredProcedure [dbo].[spRenewInsurance]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
    ...
    BEGIN
        ...
        SET @NewStartingDate = DATEADD(DAY, 1, @CurrentExpiryDate)
...
END
GO
/****** Object:  StoredProcedure [dbo].[spRentCar]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[spRentCar]
    @CustID		INT,
    @CarID		INT,
    @NbDays		INT,
    @CardNumber VARCHAR(16),
...
/****** Object:  StoredProcedure [dbo].[spRentedBetween]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[spSignIn]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [dbo].[spSignOut]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [dbo].[spSignUp]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [dbo].[spSubscribe]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[spUpdateExpiredSubscriptions]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[spValidateCard]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[spViewMatches]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[spViewMyCards]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[spViewMyRents]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[spViewMyRequests]    Script Date: 12/31/2023 12:48:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	...
	SELECT  REQUESTID	   AS		[My Request ID],
